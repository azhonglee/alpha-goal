...
grep -q "allow_implicit_invocation: false" "$tmp_codex/.codex/skills/deep-interview/agents/openai.yaml"
...
grep -q "allow_implicit_invocation=false" "$tmp_codex/.codex/hooks.json"
grep -q "exact task directory preserved in current task context" "$tmp_codex/.codex/hooks.json"
grep -q "available only through explicit skill invocation" "$tmp_codex/.codex/hooks.json"
