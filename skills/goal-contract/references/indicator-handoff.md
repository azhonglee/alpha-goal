...
Use an Indicator Handoff when qualitative goals, Synthesis Round indicators, or acceptance expectations must become observable evidence for `system-model`, `control-loop`, or `evidence-verify`.
...
- Pass accepted indicators into the Goal Contract, system model sensors, Control Law thresholds, and verification evidence boundary.
