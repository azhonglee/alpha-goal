---
name: control-loop
description: "Use only after an explicit goal specification or equivalent grants a specific read-only probe or implementation boundary. Do not use for ambiguous planning."
---
