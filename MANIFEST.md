...
| `<state-root>/YYYYMMDD-<TaskName>/checkpoint.md` | Required during executor runs for current slice, completed actions, raw evidence, acceptance checklist, known gaps, blockers, verification result, and next route. |
