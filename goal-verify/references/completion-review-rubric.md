...
For low-risk local bugs with a focused failing test and direct branch/code divergence, do not require incident-style RCA evidence; narrow the final claim to the tested local boundary.
